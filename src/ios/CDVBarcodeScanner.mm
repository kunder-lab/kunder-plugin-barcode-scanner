...
//    self.previewLayer = nil;
    ...
    //Cambiar a 1 para volver a antes de arreglo de AM.
    [self performSelector:@selector(openDialog) withObject:nil afterDelay:1.5];
}
...
/*    [self.parentViewController
     ...
     //// FIX DE AM, para revertir descomentar líneas anteriores y borrar línea de abajo
